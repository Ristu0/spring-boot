                                ...
                                <form class="form-horizontal" role="form">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">
                                            项目名称：</label>
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1" placeholder="输入项目名称"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" placeholder="输入申请人"
                                                   class=" col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" placeholder="输入贷款总额"
                                                   class=" col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1-1" placeholder="输入年利率"
                                                   class=" col-xs-10 col-sm-5"/>%
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right"
                                               for="form-field-2">投标密码： </label>

                                        <div class="col-sm-9">
                                            <input type="password" id="form-field-2" placeholder="输入投标密码"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
